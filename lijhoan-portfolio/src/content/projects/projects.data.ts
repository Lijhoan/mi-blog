...
export const projectArchive: ProjectItem[] = [
  {
    ...
    client: 'Tale Inmobiliaria',
    status: 'pending-verification',
    note: 'Incluido en la fuente markdown; aún no se muestra en la UI scrollytelling actual.',
  },
  {
    id: 5,
    ...
    status: 'pending-verification',
    note: 'Incluido en la fuente markdown; no existe un asset dedicado en el workspace.',
  },
]
